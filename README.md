...
| M3 | text／graphics 平面 ＋ 調色盤 | 標題畫面與 MAME 的索引截圖逐點相同 | **文字面完成**（131,072 bytes 與 MAME 相同，`docs/findings/009`）；**圖形面 63.30%**（`docs/findings/015`、`016`：高 byte 的差異來自一個沒初始化的暫存器；真機 USP 已量到 `0x0009C768`，與我們差 168 bytes）|
