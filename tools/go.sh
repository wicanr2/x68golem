...
PASS=()
for v in GOOS GOARCH CGO_ENABLED X68GOLEM_TEST_Z X68GOLEM_TEST_DISK X68GOLEM_TEST_DISKS X68GOLEM_TEST_CGROM X68GOLEM_TEST_MAME_TVRAM X68GOLEM_TEST_X; do
  [[ -n "${!v:-}" ]] && PASS+=(-e "$v=${!v}")
done
